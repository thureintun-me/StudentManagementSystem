...
<body class="main_body">
    ...
    <div id="container"> 
        ...
        <div id="main_contents">   
			<div id="contents">
				<h3>User Update</h3>
				<label id="errormsg" > </label><br/><br/><br/>

				<form action="UpdateUserServlet" method="post">
					<table class="tableForm">
						<tr>
							<td class="tblSingleLabel"> User ID *</td>
							<td class="tblSingleInput"><input type="text" class="txtlong_popup" id="txtUserName" name="id" value="${ param.id}" /></td>              
						</tr></td>
						</tr>
						<tr>
						...
						<tr>
							...
							<td class="tblSingleInput"><input type="password" class="txtlong_popup" id="txtUserName" name="confirmPass" value="${param.password }"/></td>              
						</tr>
					</table>
					<br/>
