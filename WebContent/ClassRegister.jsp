    ...
    <div id="container"> 
        ...
        <div id="main_contents"> 
			<div id="contents">
				...
				<form name="registerForm" action="AddClassServlet" method="post">
					<table class="tableForm">
						<tr>
							<td class="tblSingleLabel"> Class ID *</td>
							<td class="tblSingleInput"><input type="text" name="id" id="txtUserId" class="txt_popup" value="CL001"/></td>
						</tr>
						<tr>
							<td class="tblSingleLabel">Class Name *</td>
							<td class="tblSingleInput"><input type="text" name="name" class="txtlong_popup" id="txtUserName" value="Java Web Development"/></td>              
						</tr>
